...
// All this structs and functions were all developed by Ferrolho
...
//This ones were developed by us

/**
 * @brief      Draws an unscaled, unrotated bitmap at the given position without
 *             the background
 *
 * @param      bitmap     bitmap to be drawn
 * @param      x          destiny x coord
 ...
 * @param      alignment  image alignment
 */
void drawSprite(Bitmap* bitmap, int x, int y, Alignment alignment);

/**
 * @brief      Draws an unscaled, inverted bitmap at the given position without
 *             the background
 *
 * @param      bitmap     The bitmap
 * @param[in]  x          destiny x coord
 * @param[in]  y          destiny y coord
 * @param[in]  alignment  The alignment
 */
void drawSpriteInverted(Bitmap* bitmap, int x, int y, Alignment alignment);
