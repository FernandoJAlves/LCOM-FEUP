...
typedef struct {
  ...
  phys_bytes PhysBasePtr;       /**< @brief physical auint32_tress for flat memory frame buffer */
...
/**
 * @brief Returns information on the input VBE mode, including screen dimensions, color depth and VRAM physical auint32_tress
 * 
 * Initializes unpacked vbe_mode__info_t structure passed as an auint32_tress with
 ...
 * @param vmi_p auint32_tress of vbe_mode_info_t structure to be initialized
...
/**
 * @brief      Gets the information about the current mode
 *
 * @param[in]  mode   The mode
 * @param      vmi_p  The vmi where the information will be stored
 *
